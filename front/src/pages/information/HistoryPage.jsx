        ...
        <BasicLayout>
            ...
            <main className='historyMain'>
                ...
                <div>
                    ...
                    <p>역사
                        고대 ~ 중세
                        맥주에다 벌꿀이나 과즙을 타서 마셨고 로마시대 때에는 포도주에다 물을 타서 마셨다. 이렇게 간단하게 섞어서 마신 원시적인 방법이 칵테일의 시작이며, 이때는 쉐이커나 믹싱 글라스 등의 기구를 사용한 것이 아니라 그냥 재료를 섞어서 맛을 변화시켜 마신 것이 전부였다. 중국 당나라시대에서는 와인에다 마유 등을 섞은 유산 음료도 칵테일의 일종이라고도 하며, 중세에는 추위를 이기기 위하여 향료를 섞어 뜨겁게 마셨으며, 아라크에다 설탕, 물, 라임, 향료를 섞은 펀치가 만들어졌다. 이때까지 양조주만을 주재료로 하여 섞어 마시던 것이 중세에 들어서 연금술사들이 만든 증류주로 인하여 믹스드 드링크에도 큰 발전이 시작되었다. 18세기 중반에 들어서서 이런 혼합 음료를 칵테일이라는 이름으로 부르게 되었다.

                        근대 ~ 현대
                        제1차 세계 대전 때 미군들이 유럽에 보급시켰고, 20세기 초반 미국의 금주법 시대때 일자리를 잃은 많은 바텐더들이 유럽으로 건너가서 유럽에 칵테일을 활성화 시켰다. 얼음을 사용한 칵테일이 대중화된 것은 19세기 후반 독일의 카알 폰 린데가 인공 제빙기를 개발하면서부터이다. 한국은 8.15 광복과 함께 서양 문물이 들어오고 6.25전쟁 이후 미군들에 의해서 칵테일이 서서히 보급되기 시작하여 오늘날에 이르고 있다.</p>
                </div>
